...
<body>
 ...
 <a href="ctor.php" style="color:#000;">Add Tournament</a><br><br>
...
<form name="view" method="post">
  <table align="center" class="record_table" >
    ...
    <?php
  include ("con.php");
   $query = "SELECT * FROM alta WHERE empresa_id='$id'";
...
?>
  ...
  <!--<label for="squaredThree"></label>-->
      ...
      <td><a href="?delete_id=<?php echo $torid;?>&amp;action=delete"><b>Delete</b></a> || <a href="edit.php?edit_id=<?php echo $torid; ?>"><b>Edit</b></a></td>
    </tr>
